...
---
- [一、DDoS 攻击的含义](#一ddos-攻击的含义)
- [二、DDoS 攻击的工作原理是什么？](#二ddos-攻击的工作原理是什么)
- [三、DDoS 攻击类型](#三ddos-攻击类型)
- [四、DDoS 攻击中涉及的 OSI 模型中的七个网络连接层](#四ddos-攻击中涉及的-osi-模型中的七个网络连接层)
- [1.容积攻击](#1容积攻击)
  - [常见的容积攻击类型](#常见的容积攻击类型)
- [1.UDP 泛洪攻击](#1udp-泛洪攻击)
- [2.DNS 反射/放大](#2dns-反射放大)
- [3.ICMP 泛洪攻击](#3icmp-泛洪攻击)
- [4.协议攻击](#4协议攻击)
- [5.SYN 泛洪攻击](#5syn-泛洪攻击)
- [6.Smurf DDoS 攻击](#6smurf-ddos-攻击)
- [7.应用层攻击](#7应用层攻击)
    - [示例：HTTP 泛洪攻击](#示例http-泛洪攻击)
- [四、DDoS 攻击的目的是什么？](#四ddos-攻击的目的是什么)
- [五、DDoS 防御教程](#五ddos-防御教程)
  - [1.采用高性能的网络设备](#1采用高性能的网络设备)
  - [2.尽量避免 NAT 的使用](#2尽量避免-nat-的使用)
  - [3.充足的网络带宽保证](#3充足的网络带宽保证)
  - [4.升级主机服务器硬件](#4升级主机服务器硬件)
  - [5.把网站做成静态页面或者伪静态](#5把网站做成静态页面或者伪静态)
  - [6.增强操作系统的 TCP/IP 栈](#6增强操作系统的-tcpip-栈)
  - [7.安装专业抗 DDoS 防火墙](#7安装专业抗-ddos-防火墙)
  - [8.HTTP 请求的拦截](#8http-请求的拦截)
  - [9.备份网站](#9备份网站)
  - [10.部署 CDN](#10部署-cdn)
- [六、游戏怎么避免 DDOS](#六游戏怎么避免-ddos)
...
要防御 DDos 攻击，推荐 StrongVPN, 使用 StrongVPN，你真实的 IP 地址被隐藏，StrongVPN 会加密您的每台设备（包括实时消息应用程序）、以使您的加密变得无懈可击。通过加密所有互联网流量来防止黑客进入您的个人信息。使 ISP 和第三方无法监视您的活动、并帮助您匿名浏览互联网。

StrongVPN 的恶意网站屏蔽和广告拦截功能，可以拦截不必要的流量和垃圾广告信息等，让你可以不受干扰的自由的上网，没有任何打扰或者障碍。