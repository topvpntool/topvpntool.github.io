...
从 2019 年下半年开始，很多 VPN 都开始被阻止，强如 VyprVPN，CyberGhost 等巨头也是状况频频，只有少数几家专门为中国优化的 VPN，直到今天还能在中国大陆顺畅使用。那么除了 VPN，还有什么其他的方式可以帮助我们科学上网呢？
...
- [什么是 SS/SSR？](#什么是-ssssr)
- [什么是 V2Ray？](#什么是-v2ray)
- [什么是 Trojan、Trojan-Go？](#什么是-trojantrojan-go)
- [什么是 Xray](#什么是-xray)
- [5 种翻墙方式整体对比](#5-种翻墙方式整体对比)
  - [封装流量](#封装流量)
  - [加密流量](#加密流量)
- [VPN 与 SSR、V2Ray 等的区别及优缺点](#vpn-与-ssrv2ray-等的区别及优缺点)
  - [VPN 是什么](#vpn-是什么)
- [该如何选择翻墙方式？](#该如何选择翻墙方式)
- [SSR Windows 客户端使用教程](#ssr-windows-客户端使用教程)
- [总结](#总结)
- [SSR 是什么？](#ssr-是什么)
- [VPN 是什么？](#vpn-是什么-1)
- [V2Ray是什么？](#v2ray是什么)
- [vpn 和 ss/ssr 的优缺点](#vpn-和-ssssr-的优缺点)
- [SSR 翻墙提醒](#ssr-翻墙提醒)
  - [1. SSR 并不完美](#1-ssr-并不完美)
  - [2. 不要在公网分享 SSR](#2-不要在公网分享-ssr)
  - [3. 慎用免费 SSR 节点](#3-慎用免费-ssr-节点)
  - [4. 明白自建的局限](#4-明白自建的局限)
- [SSR 节点类型](#ssr-节点类型)
  - [1. 免费 SSR 节点](#1-免费-ssr-节点)
  - [2. 用 SSR 订阅地址（自动更新）](#2-用-ssr-订阅地址自动更新)
  - [3. 购买 SSR 帐号，SSR 机场推荐](#3-购买-ssr-帐号ssr-机场推荐)
- [总结](#总结-1)
...
这些复杂的协议与 VPN 之间的比较相信大家已经有了明确的认识，关于如何选择的问题，通过自身的情况判断就好了，我自己还是继续用我的 StrongVPN，不为别的，就是方便。
...
如果想要简单方便还安全的翻墙工具，还是建议大家使用 VPN,同样是付费，减少了很多复杂的操作，可持续性和可操作性强，VPN 推荐使用 StrongVPN，价格便宜，线路多，3000+高速服务器遍布全球，快速实现匿名翻墙，特殊时期也能用的 VPN.
...
最快捷简单高效的翻墙工具是使用成熟的 VPN，这样的 VPN 使用稳定，不需要额外的设置，安全性高，保证你的翻墙之旅高枕无忧，推荐使用 StrongVPN，VPN 界的性价比之王。
